...
Indexes include *more information* and are now also *faster*. Because of this a **reindex will be necessary** when upgrading as the address and database indexes are now a part of bitcoind with three new `digibyte.conf` options:
- `-addressindex`
- `-timestampindex`
- `-spentindex`
