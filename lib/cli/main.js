...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the digibyte database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `digibyte-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ digibyte-node add wallet-service');
      console.log('    $ digibyte-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ digibyte-node remove wallet-service');
      console.log('    $ digibyte-node remove insight-api');
      console.log();
    });
