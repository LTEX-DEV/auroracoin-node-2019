...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the auroracoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `auroracoin-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ auroracoin-node add wallet-service');
      console.log('    $ auroracoin-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ auroracoin-node remove wallet-service');
      console.log('    $ auroracoin-node remove insight-api');
      console.log();
    });
