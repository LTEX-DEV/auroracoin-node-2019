...
/**
 * Will return the path and auroracoin-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'auroracoin-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'auroracoin-node.json'))
  };
}
