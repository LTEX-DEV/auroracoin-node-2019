...
/**
 * Will return the path and digibyte-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'digibyte-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'digibyte-node.json'))
  };
}
